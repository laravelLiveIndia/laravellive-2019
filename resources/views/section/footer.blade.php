                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-4">
                                {{-- <div class="csi-footer-logo"> --}}
                                    <h2 style="color:white">Laravel<span style="color:#f55247">Live</span></h2>
                                {{-- </div> --}}
                            </div>
                            <div class="col-xs-12 col-sm-4">
                                        ...
                                        <div id="mc_embed_signup">
                                            <form action="https://xyz.us15.list-manage.com/subscribe/post?u=a80aa20a6604dcef64860c596&amp;id=245bde01ba" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                                                <div id="mc_embed_signup_scroll">
                                                    <label for="mce-EMAIL"><h3 class="text footer-title" style="color: white; margin-top: 0px;">Subscribe to get updates</h3></label>
